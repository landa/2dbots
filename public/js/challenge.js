function initExamples(containerClassName='example-container') {
...
function initDemos(containerClassName='demo-container') {
...
function initChallenges(containerClassName='.challenge-container') {
